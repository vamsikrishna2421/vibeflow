...
# NB: filler removal is now always-on (deterministic) and AI formatting is a tray
# tier picker (Off/Fast/Balanced/Best/Offline), so neither belongs here anymore.
_CHECKS = [
